...
public class Tile23 extends Tile {
    ...
    public void init() {
        init("tile1.json");
        addTextDelegateField("TC".toUpperCase(), Boolean.valueOf(true), new String[0]);
        String str = "**";
        addTextDelegateField("TITLES".toUpperCase(), "Text B", str);
        addTextDelegateField("COLLECTION".toUpperCase(), "Text C", str);
